...
func (cq *CompanyQuery) QueryBranches() *BranchQuery {
...
func (cq *CompanyQuery) WithBranches(opts ...func(*BranchQuery)) *CompanyQuery {
	query := (&BranchClient{config: cq.config}).Query()
...
func (cq *CompanyQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Company, error) {
	...
	if query := cq.withBranches; query != nil {
		if err := cq.loadBranches(ctx, query, nodes,
			func(n *Company) { n.Edges.Branches = []*Branch{} },
			func(n *Company, e *Branch) { n.Edges.Branches = append(n.Edges.Branches, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (cq *CompanyQuery) loadBranches(ctx context.Context, query *BranchQuery, nodes []*Company, init func(*Company), assign func(*Company, *Branch)) error {
