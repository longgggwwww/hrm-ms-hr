...
func (bq *BranchQuery) QueryCompany() *CompanyQuery {
...
func (bq *BranchQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (bq *BranchQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (bq *BranchQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (bq *BranchQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (bq *BranchQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (bq *BranchQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := bq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (bq *BranchQuery) WithCompany(opts ...func(*CompanyQuery)) *BranchQuery {
	query := (&CompanyClient{config: bq.config}).Query()
...
func (bq *BranchQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Branch, error) {
	...
	if query := bq.withCompany; query != nil {
		if err := bq.loadCompany(ctx, query, nodes, nil,
			func(n *Branch, e *Company) { n.Edges.Company = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (bq *BranchQuery) loadCompany(ctx context.Context, query *CompanyQuery, nodes []*Branch, init func(*Branch), assign func(*Branch, *Company)) error {
