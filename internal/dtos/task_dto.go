...
type TaskListQuery struct {
	...
	OrderBy        string `form:"order_by" validate:"omitempty,oneof=id name code description status type process project_id department_id creator_id start_at due_date created_at updated_at"`
